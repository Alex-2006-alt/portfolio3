...
export function IntegrationsSection({ techStack }: { techStack?: any[] }) {
  const allTech = techStack && techStack.length > 0 ? techStack : [
  ...
  return (
    <section id="tech-stack" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          ...
          I have hands-on experience with modern technologies and tools to build robust applications.
        </p>
      </div>
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
            ...
            >
              ...
              <div className={`w-10 h-10 mb-6 flex items-center justify-center transition-colors ${
                ...
                {logos[tech.name] ? (
                  ...
                  <div className="w-10 h-10 bg-zinc-800 rounded flex items-center justify-center font-bold text-sm text-zinc-300">
        ...
        {/* Bottom stats row with marquee auto-scroll */}
        <div className={`pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 pb-32 lg:pb-40 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          <div className="flex justify-between items-center mb-6 px-6 lg:px-12">
            <span className="text-sm font-mono text-muted-foreground">Technologies & Ecosystems</span>
          ...
          <div className="relative overflow-hidden flex w-full">
            ...
            <div className="flex whitespace-nowrap marquee gap-3 pl-3" style={{ width: 'max-content' }}>
              {[...allTech, ...allTech, ...allTech].map((tech, index) => (
                <div 
                  key={index}
                  className="bg-zinc-900/50 border border-zinc-800 rounded-full px-4 py-2 flex items-center space-x-2 shrink-0 hover:bg-zinc-800 transition-colors cursor-default"
                >
